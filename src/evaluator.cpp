...
//        string file_name = solver_type+"_"+typeid(*model).name()+"_90sim_Manhattan_heuristic_rewardTag_discount1_default_policy_tag.txt";
        string file_name = solver_type+"_"+typeid(*model).name()+"_10sim_Manhattan_heuristic_rewardTag_discount1_default_policy_no_observation.txt";
//        string file_name = solver_type+"_"+typeid(*model).name()+"_10sim_discount1_default_policy_no_observation.txt";
